...
class ProyectoNuevoSchema(ProyectoSchema):
    ...
    participantes = fields.List(fields.Int(required=True,validate=Validacion.not_empty_or_zero_int, error_messages={"required": {"message": "Se deben indicar participantes", "code": 400}})) 
    idDirectorProyecto = fields.Integer(required=True,validate=Validacion.not_empty_or_zero_int,error_messages={"required": {"message": "Debe indicarse jefe de proyecto", "code": 400}})

class ProyectoCerradoSchema(ProyectoSchema):
    id_proyecto = fields.Integer(required=True,validate=Validacion.not_empty_or_zero_int, error_messages={"required": {"message": "Es necesario el id_proyecto", "code:": 400}})
...
class ProyectoModificarSchema(ProyectoSchema):
    id_proyecto = fields.Integer(required=True,validate=Validacion.not_empty_or_zero_int,error_messages={"required": {"message": "Es necesario el id_proyecto. Este campo no puede estar vacío", "code:": 400}})
    montoInicial = fields.Float(required=True, validate=Validacion.not_empty_or_zero_int,error_messages={"required": {"message": "Es necesario un montoInicial. Este campo no puede estar vacío.", "code": 400}})
...
class NuevoBlogProyectoSchema(Schema):
    ...
    id = fields.Integer(required=True, validate=Validacion.not_empty_or_zero_int,error_messages={"required": {"message": "Es necesario el id", "code:": 400}})
    id_proyecto = fields.Integer(required=True,validate=Validacion.not_empty_or_zero_int, error_messages={"required": {"message": "Es necesario el id_proyecto. Este campo no puede estar vacío", "code:": 400}})
