...
class NuevaMuestraSchema(MuestraSchema):
    ...
    id_experimento = fields.Int(required=True, validate=Validacion.not_empty_or_zero_int, error_messages={"required": {"message" : "Es necesario indicar el id del experimento", "code":400}})
    ...
    id_contenedor = fields.Int(required=True, validate=Validacion.not_empty_or_zero_int, error_messages={"required": {"message" : "Es necesario indicar el id_contenedor", "code": 400}})
    id_fuenteExperimental = fields.Int(required=True, validate=Validacion.not_empty_or_zero_int, error_messages={"required": {"message" : "Es necesario indicar el id de la fuente experimental", "code": 400}})

class ModificarMuestraSchema(MuestraSchema):
    id_muestra = fields.Int(required=True, validate=Validacion.not_empty_or_zero_int, error_messages={"required": {"message" : "Es necesario indicar el id del muestra", "code":400}})
    codigo = fields.Str(required=True, validate=Validacion.not_empty_string, error_messages={"required": {"message" : "Es necesario indicar el id código de la muestra", "code": 400}})
    descripcion = fields.Str(required=True, validate=Validacion.not_empty_string, error_messages={"required": {"message" : "Es necesario indicar una descripcion", "code": 400}})
    id_contenedor = fields.Int(required=True, validate=Validacion.not_empty_or_zero_int, error_messages={"required": {"message" : "Es necesario indicar el codigoContenedor", "code": 400}})
