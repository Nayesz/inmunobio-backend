...
class NuevaHerramientaSchema(Schema):
    ...
    detalle = fields.String()
    id_espacioFisico = fields.Integer(required=True,validate=Validacion.not_empty_or_zero_int,error_messages={"required": {"message": "Debe indicarse espacio fisico", "code": 400}}) 
...
class NuevoBlogHerramientaSchema(Schema):
    ...
    id_herramienta = fields.Integer(required=True,validate=Validacion.not_empty_or_zero_int,error_messages={"required": {"message": "Debe indicarse  id_herramienta", "code": 400}}) 
