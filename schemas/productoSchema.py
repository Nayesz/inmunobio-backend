...
class IdProductoSchema(Schema):
    id_producto = fields.Integer(required=True,validate=Validacion.not_empty_or_zero_int, error_messages={"required": {"message" : "Debe indicarse el id de producto", "code": 400}})
