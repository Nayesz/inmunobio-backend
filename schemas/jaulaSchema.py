...
class NuevaJaulaSchema(Schema):
    id_espacioFisico = fields.Int(required=True,validate=Validacion.not_empty_or_zero_int, error_messages={"required" : {"message" : "Es necesario indicar el id del espacio físico", "code": 400}})
    ...
    rack = fields.Int(required=True,validate=Validacion.not_empty_or_zero_int, error_messages={"required": {"message" : "Es necesario indicar el número de rack donde va a estar ubicada la jaula", "code": 400}})
    estante = fields.Int(required=True,validate=Validacion.not_empty_or_zero_int, error_messages={"required": {"message" : "Es necesario indicar el número del estante", "code": 400}})
    capacidad = fields.Int(required=True,validate=Validacion.not_empty_or_zero_int, error_messages={"required": {"message" : "Es necesario indicar la capacidad de la jaula", "code": 400}})
    id_proyecto = fields.Int()
    tipo = fields.Str()
...
class ActualizarProyectoJaulaSchema(JaulaSchema):
    id_jaula = fields.Int(required=True,validate=Validacion.not_empty_or_zero_int, error_messages={"required": {"message" : "Es necesario indicar el id de la jaula", "code" : 400}})
...
class BusquedaBlogJaula(BusquedaBlogsJaula):
    id_jaula = fields.Integer(required=True,validate=Validacion.not_empty_or_zero_int,error_messages={"required": {"message": "Debe indicarse  id_jaula", "code": 400}}) 
