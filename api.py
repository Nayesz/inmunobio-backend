...
from resources.muestraResource import BorraMuestras, CandidatosMuestraExterna,MuestrasPorIDFuente,Muestra, MuestraGrupoExperimental, MuestraProyecto
...
api.add_resource(ObtenerUsuariosParaProyecto, '/api/v1/usuariosParaProyecto/<int:id_usuario>')
...
api.add_resource(CandidatosMuestraExterna, '/api/v1/proyecto/<int:idProyecto>/muestrasExternas/<int:idExperimento>', endpoint='candidatos_muestrasext')
